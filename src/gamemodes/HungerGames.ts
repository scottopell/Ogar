...
export default class HungerGames extends Tournament{

  baseSpawnPoints: any;
  contenderSpawnPoints: any;
  borderDec: number;
  ...
  spawnVirus(gameServer,pos) {
    var v = new Virus(gameServer.getNextNodeId(), null, pos, gameServer.config.virusStartMass, null);
